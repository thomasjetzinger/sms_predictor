...
public class MainController implements PropertyChangeListener {
    ...
    @FXML
    private ProgressIndicator mLoading;
    ...
    private void onReadFileButton() {
        if (mMainModel != null) {
            ...
            Runnable runnable = () -> {
                ...
                final String msg = parsed ? "SmsCorpus Loaded" : "Loading failed!";
                Platform.runLater(() -> {
                    Toast.makeText(msg, Duration.seconds(3)).show(mPrimaryStage);
    ...
    public void setPrimaryStage(Window _primaryStage) {
        mPrimaryStage = _primaryStage;
    }
